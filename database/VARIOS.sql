...
BEGIN
    ...
    ELSIF P_ACCION = 3 THEN
        -- ELIMINAR TELÉFONO
         VSQL := 'UPDATE TELEFONOS SET ID_ESTADO = :1 WHERE ID_TELEFONO = :2';
        EXECUTE IMMEDIATE VSQL USING 2, P_ID_TELEFONO;
        COMMIT;
...
-------------------------------------CRUD CATEGORIAS
 PROCEDURE SP_CRUD_CATEGORIAS (DESCRIPCION IN VARCHAR2, P_ID IN NUMBER, P_ACCION IN NUMBER) AS
 VSQL VARCHAR2(1000);
 BEGIN
    --Agregar
    IF P_ACCION = 1 THEN
