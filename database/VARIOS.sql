...
CREATE OR REPLACE PACKAGE PKG_LEGADO AS
  --TELEFONOS
  PROCEDURE SP_GET_TELEFONOS_USUARIO (P_DATOS OUT SYS_REFCURSOR);
...
---TELEFONOS
 PROCEDURE SP_GET_TELEFONOS_USUARIO (P_DATOS OUT SYS_REFCURSOR) AS
 BEGIN
    OPEN P_DATOS FOR
    SELECT ID_TELEFONO, TELEFONO FROM TELEFONOS WHERE ID_ESTADO = 1;
EXCEPTION
