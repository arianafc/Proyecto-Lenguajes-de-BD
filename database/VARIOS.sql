...
CREATE OR REPLACE PROCEDURE SP_CRUD_CONSULTAS (
    P_ACCION IN NUMBER,
    P_ID     IN NUMBER
)
AS
...
CREATE OR REPLACE PROCEDURE SP_GET_PEDIDOS_USUARIO (
...
CREATE OR REPLACE PROCEDURE SP_GET_PEDIDOS_DETALLES (
    P_DATOS OUT SYS_REFCURSOR,
    P_ID    IN  NUMBER
)
AS
...
----- CRUD PRODUCTOS -----
CREATE OR REPLACE FUNCTION FN_CONTAR_PRODUCTOS_REGISTRADOS RETURN NUMBER
AS
    V_ERROR   VARCHAR2(2000);
    V_CONTAR  NUMBER;
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_ELIMINAR_ACTIVAR_PRODUCTO (
    P_ID     IN NUMBER,
    P_ESTADO IN NUMBER
)
AS
...
CREATE OR REPLACE PROCEDURE SP_GET_CATEGORIAS (
    P_DATOS OUT SYS_REFCURSOR
) AS
    V_ERROR VARCHAR2(2000);
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_GET_PRODUCTO_ID (
    P_DATOS OUT SYS_REFCURSOR,
    P_ID    IN  NUMBER
)
AS
...
END SP_GET_PRODUCTO_ID;


CREATE OR REPLACE PROCEDURE SP_GET_PRODUCTOS_ACTIVOS (
    P_DATOS OUT SYS_REFCURSOR
)
AS
    V_PRODUCTOS NUMBER;
