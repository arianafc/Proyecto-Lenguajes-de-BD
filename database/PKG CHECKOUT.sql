...
PROCEDURE SP_EJECUTAR_CHECKOUT (P_CARRITO IN NUMBER, P_ID_USUARIO IN NUMBER);
...
CREATE OR REPLACE PACKAGE BODY PKG_CHECKOUT AS
    ...
    BEGIN
        ...
        INSERT INTO PEDIDOS (FECHA, ID_USUARIO, ID_ESTADO, SUBTOTAL, TOTAL)
        VALUES (SYSDATE, P_ID_USUARIO, 3, V_SUBTOTAL, V_SUBTOTAL * 1.13);
